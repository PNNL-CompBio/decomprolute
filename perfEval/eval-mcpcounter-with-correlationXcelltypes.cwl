...
class: Workflow
label: eval-mcpcounter-with-correlationXcelltypes
id: eval-mcpcounter-with-correlationXcelltypes
cwlVersion: v1.0
...
steps:
  ...
  calc-corr:
    run: deconv-corrXcelltypes-cwl-tool.cwl
    in:
      transcriptomics:
