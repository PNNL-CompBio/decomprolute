...
a <- 'CIBERSORTx_Job9_Adjusted_CCRCC_RNA_paper_sc3PBMC.txt'
...
rel <- rel[,c("B cells","T cells CD4","T cells CD8","Dendritic cells","Megakaryocytes","Monocytes","NK cells")]
...
pdf("Heatmap_CCRCC_RNA_paper_sc3PBMC.pdf", width = 20, height = 8)
...
save(tmp,ha,file = 'CCRCC_RNA_paper_sc3PBMC.RData')
tabM <- melt(tmp)
...
ggsave(pmerged,
       file = 'Boxplot_CCRCC_RNA_paper_sc3PBMC.pdf',
       width = 20,
       height = 15)
