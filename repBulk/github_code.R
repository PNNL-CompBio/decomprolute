# -- load function
source("/bin/function_bulk_repulsive_github.R")
...
input_f_data <- args[2]
n.iter<-args[3] # should there be a default?
burn.in<-args[4]
...
write.table(gibbs[[1]][[1]],"output_rep_bulk.tsv",row.names=TRUE, col.names=NA, sep='\t', quote = FALSE)
