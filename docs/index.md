...
The goal of this package is to run and evaluate tumor deconvolution algorithms on multi-omics data. To use, we provide two primary scenarios:
1. Evaluate the performance of new algorithms on proteogenomic data
2. Identify the *best* tool for unseen proteogenomic data
If you are interesting in adding your own algorithm, please see our [GitHub site](http://github.com/pnnl-compbio/decomprolute).
